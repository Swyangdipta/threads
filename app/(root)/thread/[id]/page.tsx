...
{thread.children.map((child:any)=>(
    <div>
    <ThreadCard key={child._id} id={child._id} currentUserId={child?.id||''} parentId={child.parentId} content={child.text} author={child.author} community={child.community} createdAt ={child.createdAt} comments={child.children} isComment/>
    </div>
))}
</div>
</section>
